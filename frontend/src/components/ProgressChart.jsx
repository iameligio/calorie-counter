...
const ProgressChart = ({ data, period, setPeriod }) => {
  if (!data || data.length === 0) {
    return (
      <div className="flex items-center justify-center h-64 bg-white rounded-2xl border border-gray-100 shadow-xl shadow-gray-200/50">
        <p className="text-gray-500">Not enough data to show progress yet.</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-xl shadow-gray-200/50 p-6">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h3 className="text-xl font-bold text-gray-800">Calorie Progress</h3>
          <p className="text-sm text-gray-500">Track your daily consumption vs target</p>
        </div>
